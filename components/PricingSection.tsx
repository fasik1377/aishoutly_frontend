        ...
        <section id="pricing" className="py-16 md:py-28 bg-white">
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                ...
                <div className="text-center mb-12 md:mb-16">
                    <h2 className="text-2xl md:text-4xl text-black mb-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10">
                    ...
                    {/* Growth Plan */}
                    <div className="relative bg-gradient-to-br from-blue-500 to-purple-600 rounded-3xl p-6 md:p-10 shadow-xl">
            ...
            <div className="mt-16 md:mt-24 text-center px-4">
                ...
                <Link
                    href="/signup"
                    className="inline-flex items-center justify-center w-full sm:w-auto px-10 py-4 rounded-full bg-black text-white text-lg hover:bg-gray-900 transition"
                >
